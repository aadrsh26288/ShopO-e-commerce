...
const Contact = () => {
  return (
   <div class="container pt-20 px-6 mx-auto arch">
      ...
      <div class="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
        <form>
          <div class="form-group mb-6">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-[#FFBB38] focus:outline-none" id="exampleInput7"
              placeholder="Name"/>
          </div>
          <div class="form-group mb-6">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-[#FFBB38] focus:outline-none" id="exampleInput8"
          ...
          <div class="form-group mb-6">
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-[#FFBB38] focus:outline-none
        ...
        <div class="flex flex-wrap">
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              <div class="shrink-0">
                <div class="p-4 bg-[#FFBB38] rounded-md shadow-md w-14 h-14 flex items-center justify-center">
